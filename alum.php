            ...
            <div class="container mt-5">
                    <div class="row"> 
                        ...
                        <h1>Citas Registradas</h1>
                            <table class="table" >
                                <thead class="table-secondary table table-bordered" >
                                    <tr>
                                        <th>Matricula</th>
                                        <th>Nombres</th>
                                        <th>Apellidos</th>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actu.php?id=<?php echo $row['cod_estudiante'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delet.php?id=<?php echo $row['cod_estudiante'] ?>" class="btn btn-danger">Eliminar</a></th> 
